...
import static app.searchBar.FilterUtils.filterByNameUsers;
...
public final class SearchBar {
    ...
    private List<User> resultUserSearch;
    ...
    public SearchBar(final String user) {
        ...
        this.resultUserSearch = new ArrayList<>();
        this.user = user;
    }
    ...
    public List<User> searchUsers(final Filters filters, final String type) {
        ...
        switch (type) {
            case "artist":
                ...
                if (filters.getName() != null) {
                    entries = filterByNameUsers(entries, filters.getName());
                }
                break;
            case "host":
        ...
        this.resultUserSearch = entries;
        this.lastSearchType = type;
        return this.resultUserSearch;
    }
    ...
    public User selectUser(final Integer itemNumber) {
        if (this.resultUserSearch.size() < itemNumber) {
            resultUserSearch.clear();
            return null;
        } else {
            lastUserSelected = this.resultUserSearch.get(itemNumber - 1);
            resultUserSearch.clear();
