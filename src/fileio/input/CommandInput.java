...
public final class CommandInput {
    ...
    private Integer age; // for user's age
    private String city; // for user's city
    private String name; // for album name
    private Integer releaseYear; // for album release year
    private String description; // for album description
    private ArrayList<SongInput> songs; // for album songs
    private String date; // for event
    private Integer price; // for merch
    private String nextPage; // for change page
    private ArrayList<EpisodeInput> episodes; // for podcast episodes
    private String recommendationType; // for recommendations
